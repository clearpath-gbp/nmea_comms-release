## nmea_comms (noetic) - 1.2.0-3

The packages in the `nmea_comms` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -r noetic -t noetic nmea_comms` on `Sat, 23 Jan 2021 01:13:05 -0000`
